...
APPOBJ="$OUT/appobj"
mkdir -p "$APPOBJ"
for f in LanguageCatalog StyleCatalog WorkspacePanel DocumentListPanel EditorController EditCommands SearchCommands ViewCommands AppDelegate Tests main; do
