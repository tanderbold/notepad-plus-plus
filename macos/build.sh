...
APPOBJ="$OUT/appobj"
mkdir -p "$APPOBJ"
for f in LanguageCatalog StyleCatalog WorkspacePanel DocumentListPanel FunctionListPanel EditorController EditCommands SearchCommands ViewCommands EncodingCommands AppDelegate Tests main; do
