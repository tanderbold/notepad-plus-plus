...
APPOBJ="$OUT/appobj"
mkdir -p "$APPOBJ"
for f in LanguageCatalog StyleCatalog FunctionListCatalog TabBarView WorkspacePanel DocumentListPanel FunctionListPanel AuxPanels EditorController EditCommands SearchCommands ViewCommands EncodingCommands AdvancedEditCommands ToolsCommands SettingsCommands SettingsPanels Toolbar BackupAndPrint BehaviourCommands TypingCommands CompareCommands JsonCommands AppDelegate Tests main; do
